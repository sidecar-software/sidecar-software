  ...
  return (
    <Appearable>
      ...
      <p>At Sidecar, we’re a tight-knit team of engineers rooted in Prague and connected across Western Europe.
        Our distributed setup allows us to bring global expertise with a local touch.
        We primarily serve clients across EMEA and North America,
        but our capabilities know no borders, wherever you are, we’re ready to help.</p>
      <p>
        As a proud Elastic Services Partner since 2024, we bring unmatched expertise to the table.
      ...
      <div className="team_grid">
        <div className="team_member">
          ...
          <p style={{ fontStyle: 'italic', opacity: 0.5, marginBottom: '0.25em' }}>Co-Founder & Software Developer</p>
          ...
          <div className="social">
            <a href="https://www.linkedin.com/in/bojovanovic/"><Linkedin size={24} /></a>
        ...
        <div className="team_member">
          ...
          <h3>Honza Král</h3>
          <p style={{ fontStyle: 'italic', opacity: 0.5, marginBottom: '0.25em' }}>Co-Founder & Principal Engineer</p>
          ...
          <div className="social">
            <a href="https://www.linkedin.com/in/honzakral/"><Linkedin size={24} /></a>
            <a href="https://github.com/honzakral"><Github size={24} /></a>
          </div>
        ...
        <div className="team_member">
          ...
          <h3>Karel Minařík</h3>
          <p style={{ fontStyle: 'italic', opacity: 0.5, marginBottom: '0.25em' }}>Software Developer & Architect</p>
          ...
          <div className="social">
            <a href="https://www.linkedin.com/in/karelminarik/"><Linkedin size={24} /></a>
            <a href="https://github.com/karmi"><Github size={24} /></a>
          </div>
          <h4>Blog posts</h4>
        ...
        <div className="team_member">
          ...
          <p style={{ fontStyle: 'italic', opacity: 0.5, marginBottom: '0.25em' }}>Principal Engineer</p>
          ...
          <div className="social">
            <a href="https://www.linkedin.com/in/fpercoco/"><Linkedin size={24} /></a>
            <a href="https://github.com/flaper87"><Github size={24} /></a>
            <a href="http://www.flaper87.com"><Globe2 size={24} /></a>
          </div>
        </div>
      </div>
    </Appearable>
